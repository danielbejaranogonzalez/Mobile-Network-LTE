 ...
 * @author User
 */
public class VentanaNuevaTarjetaRadio extends javax.swing.JDialog {

    private ControladorGeneral controlador;
    private String nombreRAN, nombreENodeB, nombreRadio;
    
    /** Creates new form VentanaNuevoRadio */
    public VentanaNuevaTarjetaRadio(java.awt.Frame parent, boolean modal, ControladorGeneral controlador, String nombreRAN, String nombreENodeB, String nombreRadio) {
        super(parent, modal);
                 ...
                 for(int j=0; j < proyectos.get(i).getGrupoRANs().size(); j++){
                     if(proyectos.get(i).getGrupoRANs().get(j).getNombre().equals(nombreRAN)){
                         ...
                         try{
                             ...
                             System.out.println("Falla en el array de Tecnologias: " + IOBE.getMessage());
                         }
                             ...
                             if(listaNodos.get(k).getNombre().equals(nombreENodeB)){
                                 ...
                                 for(int l=0; l < radios.size(); l++){
                                    if(radios.get(l).getNombre().equals(nombreRadio)){
                                        ...
                                        numeroSlot.setModel(new DefaultComboBoxModel(radios.get(l).obtenerTargetasRadioSlotVacios()));
                                    }
                                 }
                             }
                         }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/iconos32x32/card-add.png"))); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel2.setText("Asistente para la creacion de un nueva Tarjeta de Radio");
        ...
        potenciaMax.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(32.0f), Float.valueOf(-50.0f), Float.valueOf(100.0f), Float.valueOf(0.5f)));
        potenciaMax.setName("potenciaMax"); // NOI18N

        jLabel10.setText("Sensibilididad Rx:");
        jLabel10.setName("jLabel10"); // NOI18N

        sensivilidadMax.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(-80.0f), Float.valueOf(-200.0f), Float.valueOf(0.0f), Float.valueOf(0.5f)));
...
private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
    ...
    try{
        controlador.getControladorVentanas().crearNuevaTargetaEquipoRadio(nombreRAN, nombreENodeB, nombreRadio, Integer.parseInt(numeroSlot.getSelectedItem().toString()), 
        ...
        JOptionPane.showMessageDialog(null, "'Existen campos vacios o valores incorrectos'","Error 002: NullPointerException",JOptionPane.ERROR_MESSAGE);
    }
        ...
        for(int i=0; i < TarjetaRadio.getBANDAS_DE_FRECUENCIA_FDD().length; i++){
          ...
          for(int i=0; i < TarjetaRadio.getBANDAS_DE_FRECUENCIA_TDD().length; i++){
            if( TarjetaRadio.getBANDAS_DE_FRECUENCIA_TDD()[i].equals(bandaFrecuencia.getSelectedItem().toString())){
                ...
                anchoBandaUpLink.setText("" + ((double)(TarjetaRadio.getFRECUANCIA_SUPERIOR_ALLOCATION_TDD()[i])-((double)TarjetaRadio.getFRECUANCIA_INFERIOR_ALLOCATION_TDD()[i])));
                anchoBandaDownLink.setText("" + ((double)(TarjetaRadio.getFRECUANCIA_SUPERIOR_ALLOCATION_TDD()[i])-((double)TarjetaRadio.getFRECUANCIA_INFERIOR_ALLOCATION_TDD()[i])));
            }
        }
     }
