 ...
 * @author User
 */
public class VentanaEliminarRadio extends javax.swing.JDialog {

    private ControladorGeneral controlador;
    
    /** Creates new form VentanaEliminarAntena */
    public VentanaEliminarRadio(java.awt.Frame parent, boolean modal, ControladorGeneral controlador, String nomRAN, String nomENodeB, String nomRadio) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Equipo de Radio");
        setIconImage(new ImageIcon("src/Images/iconos16x16/stanchion-remove.png").getImage());
        setResizable(false);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/iconos32x32/stanchion-remove.png"))); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel2.setText("Asistente para la eliminacion del Equipo de Radio seleccionado");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nombreRadio, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(77, 77, 77)
...
private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
    controlador.getControladorVentanas().eliminarRadio(nombreRadio.getText(), nombreRAN.getText(), nombreENodeB.getText());
    this.dispose();
