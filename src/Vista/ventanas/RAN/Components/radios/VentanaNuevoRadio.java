 ...
 * @author User
 */
public class VentanaNuevoRadio extends javax.swing.JDialog {

    private ControladorGeneral controlador;
    private String nombreRAN, nombreENodeB;
    
    /** Creates new form VentanaNuevoRadio */
    public VentanaNuevoRadio(java.awt.Frame parent, boolean modal, ControladorGeneral controlador, String nombreRAN, String nombreENodeB) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon("src/Images/iconos16x16/stanchion-add.png").getImage());
        setResizable(false);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/iconos32x32/stanchion-add.png"))); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel2.setText("Asistente para la creacion de un nuevo Equipo de Radio");
...
private void botonAceptar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptar1ActionPerformed
        ...
        controlador.getControladorVentanas().crearNuevoEquipoRadio(nombreRAN, nombreENodeB, nombreEquipo.getText(), fabricante.getSelectedItem().toString(), estado.getSelectedItem().toString(), status);
        this.dispose();
